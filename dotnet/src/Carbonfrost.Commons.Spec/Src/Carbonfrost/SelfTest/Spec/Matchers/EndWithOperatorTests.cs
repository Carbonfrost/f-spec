...
namespace Carbonfrost.SelfTest.Spec.TestMatchers {
    ...
    class EndWithOperatorTests : SequenceComparisonOperatorTestBase<EndWithOperator> {
        ...
        public override ExampleData[] Examples {
            get {
                ...
                return new[] {
                    Example(new [] { "c" }),
                    Example(new [] { "C" }, StringComparer.OrdinalIgnoreCase),
                    Example(new [] { "c" }, comparison),
