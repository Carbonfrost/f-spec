...
namespace Carbonfrost.Commons.Spec {
    ...
    static class SpecWarning {
        ...
        public static void NoTestSubjects(this TestLog log) {
            log.Warn(SR.NoTestSubjects());
        }

        public static void NoTestMethods(this TestLog log) {
            log.Warn(SR.NoTestMethods());
        }
    }
}
