...
namespace Carbonfrost.Commons.Spec.TestMatchers {
    ...
    interface IPredicateOperator {
        ...
        void Apply<TValue>(IEnumerableExpectation<TValue> e);
        void Apply<TValue>(IEnumerableExpectation<TValue> e, Predicate<TValue> predicate);
        void Apply<TValue>(IEnumerableExpectation<TValue> e, Predicate<TValue> predicate, string message, params object[] args);
        void Apply<TValue>(IEnumerableExpectation<TValue> e, string message, params object[] args);
    }
}
