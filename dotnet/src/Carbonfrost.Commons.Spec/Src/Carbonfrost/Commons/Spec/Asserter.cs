...
namespace Carbonfrost.Commons.Spec {
    ...
    internal partial class Asserter {
        ...
        public ExpectationBuilder<IEnumerable<TValue>> Expect<TValue>(params TValue[] value) {
            return new ExpectationBuilder<IEnumerable<TValue>>(() => value, false, null, _assumption);
        }
        ...
        internal void That(Action actual, ITestMatcher matcher, string message = null, params object[] args) {
            new Expectation(ExpectationCommand.TestCode(actual, false, null, _assumption))
                .Should(matcher, message, (object[]) args);
        }

        internal void That<T>(T actual, ITestMatcher<T> matcher, string message = null, params object[] args) {
            new Expectation<T>(ExpectationCommand.Of(() => actual, false, null, _assumption))
                .Should(matcher, message, (object[]) args);
        }
